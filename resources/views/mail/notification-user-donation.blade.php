                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                                                {{ $userDonation->fullname }}<br> No Telp:
                  ...
                  normal; line-height: 1; vertical-align: top; padding: 0 0 7px; text-align: right; " align="right">
                                        ...
                                        <tr>
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b;  line-height: 18px;  vertical-align: top; padding:10px 0;" class="article">
                                                {{ $userDonation->availableDonation->short_description }}
                                            </td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; white-space:nowrap;" width="80">
                                                Rp{{ number_format($userDonation->amount, 0, '.', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; ">
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                                                <strong>Rp{{ number_format($userDonation->amount + 4400, 0, '.', '.') }}</strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <td>
                    <table width="540" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                        <tbody>
                            <tr>
                                <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: left;">
                                    Terima Kasih <strong>{{ $userDonation->fullname }},</strong> <br> Atas donasi Anda yang luar biasa. Dengan kontribusi Anda, kita dapat memberikan bantuan yang sangat dibutuhkan kepada anak-anak yang terkena dampak konflik di Gaza. Semoga kebaikan ini membawa harapan dan pemulihan bagi mereka.
